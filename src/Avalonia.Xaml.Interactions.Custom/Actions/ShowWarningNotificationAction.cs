...
/// </summary>
public class ShowWarningNotificationAction : StyledElementAction
{
    /// <summary>
    ...
    public static readonly StyledProperty<INotificationManager?> NotificationManagerProperty =
        AvaloniaProperty.Register<ShowWarningNotificationAction, INotificationManager?>(nameof(NotificationManager));

    /// <summary>
    /// Identifies the <seealso cref="Title"/> avalonia property.
    /// </summary>
    public static readonly StyledProperty<string?> TitleProperty =
        AvaloniaProperty.Register<ShowWarningNotificationAction, string?>(nameof(Title));

    /// <summary>
    /// Identifies the <seealso cref="Message"/> avalonia property.
    /// </summary>
    public static readonly StyledProperty<string?> MessageProperty =
        AvaloniaProperty.Register<ShowWarningNotificationAction, string?>(nameof(Message));
