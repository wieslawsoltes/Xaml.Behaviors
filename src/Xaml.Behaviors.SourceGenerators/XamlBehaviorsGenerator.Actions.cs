    ...
    public partial class XamlBehaviorsGenerator
    {
        ...
        private void ExecuteGenerateAction(SourceProductionContext spc, ActionInfo info)
        {
            ...
            if (info.IsAwaitable)
            {
                ...
                sb.AppendLine("        }");
                sb.AppendLine();
                sb.AppendLine("        public static readonly StyledProperty<System.Exception?> LastErrorProperty =");
                sb.AppendLine($"            AvaloniaProperty.Register<{info.ClassName}, System.Exception?>(nameof(LastError));");
                sb.AppendLine();
                sb.AppendLine("        public System.Exception? LastError");
                sb.AppendLine("        {");
            ...
            if (info.IsAwaitable)
            {
                ...
                sb.AppendLine("            {");
                sb.AppendLine("                LastError = new System.OperationCanceledException(\"Action task was canceled.\");");
                sb.AppendLine("                IsExecuting = false;");
                sb.AppendLine("                return false;");
                sb.AppendLine("            }");
                sb.AppendLine();
