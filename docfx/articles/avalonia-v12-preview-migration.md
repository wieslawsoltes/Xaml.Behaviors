...
This branch migrates `Avalonia.Xaml.Behaviors` to Avalonia 12 preview packages.

## Baseline

- Branch: `avalonia-v12`
- Avalonia package line: `12.0.0-preview2`
- Avalonia DataGrid package: `12.0.0-preview2-2`
...
- Avalonia `12.0.0-preview2` release notes
- Avalonia headless testing guidance for renderer-backed screenshots

## Migration plan

1. Move all Avalonia-consuming projects to `net8.0+`.
2. Upgrade central package versions to the latest Avalonia 12 preview set supported by the current ecosystem.
...
- Updated package management to Avalonia 12 preview packages and added `Avalonia.Skia` where renderer-backed headless tests require it.
